...
- **Start free.** Everything today works on a free tier (we'll use Antigravity).
- **Free tiers are demo-grade** — great for learning, but they hit a wall on
  sustained work, and Antigravity's free quota is the tightest.
- The on-ramp: [**Claude Pro — \$20/mo**]{.amber} (\$17 annual), **Claude Code included**, cancel anytime.
- A *one-month rental* of a pro tool — cheaper than any textbook, and often
  **expensable** (PI / training-grant funds).
- A **fork, not a hurdle**: today needs nothing; *continuing* is worth \$20.

::: notes
Be honest and non-coercive. The equity risk is not the \$20 tool — it's the free
path quietly failing, so "optional" becomes "you had to pay to keep up." So:
scope today to fit inside the free budget, and frame the subscription as "to keep
doing real work after this week," not "to survive today."

Caveats to say out loud: there is no individual student discount (only
institutional Claude for Education at partner universities); annual billing is the
only price break; Max subscribers can share 7-day guest passes that include Claude
Code. And the recommendation was tested — free terminal tools came up short for
cowork-heavy tasks; Claude Code is what actually did the job. Full version is in
the handout under "Paying for tools: an honest recommendation."
:::
...
- Antigravity: <https://antigravity.google> · Claude Code: <https://claude.com/product/claude-code>
