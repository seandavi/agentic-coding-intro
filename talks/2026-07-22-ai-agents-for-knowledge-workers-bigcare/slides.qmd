...
![](figures/papers/biomni.png){.paper-banner width="88%"}

::: {.small}
Stanford · bioRxiv 2025 · now published in *Science* (2026)
:::
...
::: {.small}
Google · accepted at *Nature* (2026)
...
::: {.small}
Stanford + CZ Biohub · *Nature* (2025)
...
![](figures/papers/crispr-gpt.png){.paper-banner width="80%"}

::: {.small}
Stanford/Princeton · *Nature Biomedical Engineering* (2025) — plans and
...
![](figures/papers/agentic-eval-cancer.png){.paper-banner width="86%"}

::: {.small}
Dana-Farber (Van Allen lab) · bioRxiv 2026 — agents tested on single-cell
multi-omics across **11 cancer types**.
:::
